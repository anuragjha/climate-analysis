...
import edu.usfca.cs.mr.wordcount.WordCountJob;
...
public class ExtremeTempJob {
    public static void main(String[] args) {
        try {
            ...
            /* Current class */
            job.setJarByClass(ExtremeTempJob.class);

            /* Mapper class */
            job.setMapperClass(ExtremeTempMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(ExtremeTempReducer.class);

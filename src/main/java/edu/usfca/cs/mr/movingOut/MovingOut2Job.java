...
public class MovingOut2Job {
    ...
    public static void main(String[] args) {
        try {
            ...
            Job job = Job.getInstance(conf, "Moving Out 2 job");

            /* Current class */
            job.setJarByClass(MovingOut2Job.class);

            /* Mapper class */
            job.setMapperClass(MovingOut2Mapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(MovingOut2Reducer.class);

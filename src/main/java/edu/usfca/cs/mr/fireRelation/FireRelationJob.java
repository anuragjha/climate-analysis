...
public class FireRelationJob {
    ...
    public static void main(String[] args) {
        try {
            ...
            /* Current class */
            job.setJarByClass(FireRelationJob.class);

            /* Mapper class */
            job.setMapperClass(FireRelationMapper.class);
            ...
            /* Reducer class */
            job.setReducerClass(FireRelationReducer.class);

            /* Outputs from the Mapper. */
            job.setMapOutputKeyClass(Text.class);
            job.setMapOutputValueClass(FireWritable.class);

...
public class FireRelationJob1 {
    ...
    public static void main(String[] args) {
        try {
            ...
            Job job = Job.getInstance(conf, "Fire correlation job");

            /* Current class */
            job.setJarByClass(FireRelationJob1.class);

            /* Mapper class */
            job.setMapperClass(FireRelationMapper1.class);
            ...
            /* Reducer class */
            job.setReducerClass(FireRelationReducer1.class);

            /* Outputs from the Mapper. */
            job.setMapOutputKeyClass(Text.class);
            job.setMapOutputValueClass(FireWritableFactors.class);

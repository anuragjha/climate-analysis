...
public class ExtremeTemperatureJob {
    public static void main(String[] args) {
        try {
            ...
            /* Current class */
            job.setJarByClass(ExtremeTemperatureJob.class);

            /* Mapper class */
            // job.setMapperClass(WordCountMapper.class);

            job.setMapperClass(ExtremeTemperatureMapper.class);
            ...
            job.setReducerClass(ExtremeTemperatureReducer.class);

            /* Outputs from the Mapper. */
            job.setMapOutputKeyClass(Text.class);
            //job.setMapOutputValueClass(IntWritable.class);
            job.setMapOutputValueClass(TemperatureDetails.class);
